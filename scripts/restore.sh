...
#   ./scripts/restore.sh /backup/sm-backup-dr/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-backup-dr/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
...
SERVICE_NAME="sm-backup-dr"
DB_HOST="${DB_HOST:-postgres}"
DB_PORT="${DB_PORT:-5432}"
DB_NAME="${DB_NAME:-sm_backup_dr_db}"
